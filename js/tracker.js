class MazkiPlayTracker {
    ...
    return {
        ...
        '821': { city: 'Tasikmalaya', province: 'Jawa Barat', lat: -7.3278, lng: 108.2125, carrier: 'Telkomsel' },
        '822': { city: 'Garut', province: 'Jawa Barat', lat: -7.2036, lng: 107.5661, carrier: 'Telkomsel' },
        '823': { city: 'Ciamis', province: 'Jawa Barat', lat: -7.3234, lng: 108.3523, carrier: 'Telkomsel' },
        
        // 🔥 JAWA TENGAH (80+ Prefix)
        ...
        '824': { city: 'Tegal', province: 'Jawa Tengah', lat: -6.8694, lng: 109.1338, carrier: 'Telkomsel' },
        '825': { city: 'Solo', province: 'Jawa Tengah', lat: -7.5688, lng: 110.8282, carrier: 'Telkomsel' },
        '826': { city: 'Purwokerto', province: 'Jawa Tengah', lat: -7.4192, lng: 109.2344, carrier: 'Telkomsel' },
        '827': { city: 'Kudus', province: 'Jawa Tengah', lat: -6.8028, lng: 110.8376, carrier: 'Telkomsel' },
        '828': { city: 'Magelang', province: 'Jawa Tengah', lat: -7.4703, lng: 110.2179, carrier: 'Telkomsel' },
        
        // 🔥 JAWA TIMUR (90+ Prefix)
        ...
        '838': { city: 'Sidoarjo', province: 'Jawa Timur', lat: -7.4481, lng: 112.7175, carrier: 'XL' },
        '839': { city: 'Jember', province: 'Jawa Timur', lat: -8.1738, lng: 113.7158, carrier: 'XL' },
        '832': { city: 'Madiun', province: 'Jawa Timur', lat: -7.6315, lng: 111.5249, carrier: 'Telkomsel' },
        '834': { city: 'Kediri', province: 'Jawa Timur', lat: -7.8175, lng: 112.0159, carrier: 'Telkomsel' },
        ...
        '831': { city: 'Padang', province: 'Sumatera Barat', lat: -0.9493, lng: 100.3542, carrier: 'Telkomsel' },
        '835': { city: 'Pekanbaru', province: 'Riau', lat: 0.5323, lng: 101.4443, carrier: 'Telkomsel' },
        '836': { city: 'Bengkulu', province: 'Bengkulu', lat: -3.7954, lng: 102.2603, carrier: 'Telkomsel' },
        
        // 🔥 KALIMANTAN (30+ Prefix)
        '841': { city: 'Pontianak', province: 'Kalimantan Barat', lat: -0.0180, lng: 109.3429, carrier: 'Telkomsel' },
        '842': { city: 'Balikpapan', province: 'Kalimantan Timur', lat: -1.2673, lng: 116.8235, carrier: 'Telkomsel' },
        '843': { city: 'Banjarbaru', province: 'Kalimantan Selatan', lat: -3.4303, lng: 114.8504, carrier: 'Telkomsel' },
        
        // 🔥 SULAWESI (25+ Prefix)
        '817': { city: 'Makassar', province: 'Sulawesi Selatan', lat: -5.1472, lng: 119.4101, carrier: 'Telkomsel' },
        '847': { city: 'Manado', province: 'Sulawesi Utara', lat: 1.4828, lng: 124.8439, carrier: 'Telkomsel' },
        '848': { city: 'Gorontalo', province: 'Gorontalo', lat: 0.5411, lng: 123.0512, carrier: 'Telkomsel' },
        
        // 🔥 MALUKU & PAPUA
        '849': { city: 'Ambon', province: 'Maluku', lat: -3.6954, lng: 128.1831, carrier: 'Telkomsel' },
        '844': { city: 'Jayapura', province: 'Papua', lat: -2.5488, lng: 140.7201, carrier: 'Telkomsel' },
        
        // 🔥 BALI & NTT/NTB
        '893': { city: 'Denpasar', province: 'Bali', lat: -8.6705, lng: 115.2126, carrier: 'Smartfren' },
        '845': { city: 'Mataram', province: 'NTB', lat: -8.5837, lng: 116.1193, carrier: 'Telkomsel' },
        '846': { city: 'Kupang', province: 'NTT', lat: -10.1806, lng: 123.6075, carrier: 'Telkomsel' },
        
        // 🔥 XL, INDOSAT, TRI, SMARTFREN (Nationwide)
        ...
        '888': { city: 'Batam', province: 'Kep. Riau', lat: 1.1377, lng: 104.0128, carrier: 'Smartfren' },
